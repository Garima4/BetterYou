...
<div class="container mt-5">
    <form action="pchange_password_action.php" method="post">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <span class="mt-4"><?php echo $_SESSION['patient'] ?></span>
                        <input type="hidden" name="email" id="email" value="<?php echo $_SESSION['patient'] ?>"/>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
